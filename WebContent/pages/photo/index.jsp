...
<title>Pictures-COMPANY HOMEPAGE</title>
...
<div id='content' style='width:1002px;height:365px;background:url(../effect/source/bg/cbg.png);margin:0px auto'>


<!-- 当前位置提示条 -->

<div id='pdv_16085' class='pdv_class'  title='当前位置' style='width:752px;height:45px;top:0px;left:250px; z-index:2'>
<div id='spdv_16085' class='pdv_content' style='overflow:hidden;width:100%;height:100%'>
...
<div id='pdv_17539' class='pdv_class'  title='Photo Search' style='width:250px;height:203px;top:161px;left:0px; z-index:4'>
<div id='spdv_17539' class='pdv_content' style='overflow:hidden;width:100%;height:100%'>
...
<div id='pdv_17538' class='pdv_class'  title='Photo' style='width:250px;height:158px;top:0px;left:0px; z-index:5'>
<div id='spdv_17538' class='pdv_content' style='overflow:hidden;width:100%;height:100%'>
<div class="pdv_border" style="border:0px;height:100%;padding:0;margin:0;">
<div style="height:41px;border:0px;padding:0;margin:0;background:url(../base/border/776/images/title.png) repeat-x">
<div style="float:left;font:14px/41px Verdana,microsoft yahei,Arial;padding-left:20px;color:#fff;">
	Photo
...
<div id='pdv_16099' class='pdv_class'  title='' style='width:717px;height:233px;top:69px;left:272px; z-index:6'>
...
<div id="showpages" >
	  <div id="pages"><ul><li class="pbutton"><a href=/8127_6493/photo/index.php?page=1&amp;key=>首页</a></li><li class="pbutton">上一页</li><li class="pagesnow">1</li><li class="pbutton">下一页</li><li class="opt"><select onChange="window.location=this.options[this.selectedIndex].value"><option value="/8127_6493/photo/index.php?page=1&amp;key=" selected>第1页</option></select></li><li class="pbutton"><a href=/8127_6493/photo/index.php?page=1&amp;key=>尾页</a></li></ul></div>
     </div>
