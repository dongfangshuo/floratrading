	...
	$("div#contentpages").empty();
		...
		$.ajax({
			...
			success: function(msg){
				...
				$("div#contentpages").append("dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd");
	...
	$.fn.getContent = function(productid,productpageid){
		...
		$.ajax({
			...
			success: function(msg){
				  ...
				  $("body").append("<img id='productpic' class='productpic' src='"+projectPath+"/pages/base/images/prods/"+msg+"'>");
