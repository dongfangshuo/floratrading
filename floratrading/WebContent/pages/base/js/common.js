...
$(document).ready(function() {
	...
	$("img#codeimg").click(function () { 
		$("img#codeimg")[0].src=PDV_RP+"codeimg.html?"+Math.round(Math.random()*1000000);
	 });
		...
		$.ajax({
			...
			success: function(msg){
				...
				$('img#zhuce').click(function() { 
					$.unblockUI(); 
					window.location=PDV_RP+"member/reg.html";
				}); 

				$("img#fmCodeImg").click(function () { 
					$("img#fmCodeImg")[0].src=PDV_RP+"codeimg.html?"+Math.round(Math.random()*1000000);
				 });
